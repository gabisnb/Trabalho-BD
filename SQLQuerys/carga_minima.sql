...
INSERT INTO Plano (id_plano, duracao, valor)
VALUES
...
INSERT INTO Estudante (id_usuario)
VALUES
    ('user1'),
    ('user2');
...
INSERT INTO Assinatura (id_plano, id_usuario, data_inicio, valor_mensal, data_fim)
VALUES
    ('plano_mensal', 'user1', '2024-09-01', 49.90, '2024-10-01'),
    ('plano_anual', 'user2', '2024-09-01', 37.50, '2025-09-01');

-- Inserção na Tabela Area
INSERT INTO Area (id_area, nome_area, descricao_area)
VALUES
...
INSERT INTO Curso (id_curso, nome_curso, descricao_curso, id_area, id_usuario)
VALUES
...
INSERT INTO Certificado (id_certificado, data_certificado, id_usuario, id_curso)
VALUES
    ('cert_java_001', '2024-09-02', 'user1', 'curso_java');

-- Inserção na Tabela Servico
INSERT INTO Servico (id_servico, url, id_curso)
VALUES
...
INSERT INTO Aula (id_aula, nome_aula, resumo_aula, professor, duracao_aula, url_video, id_curso, id_usuario)
VALUES
...
INSERT INTO Assiste (id_usuario, id_aula, concluida)
VALUES
    ('user1', 'aula_java_01', TRUE),
    ('user2', 'aula_photoshop_01', FALSE);

-- Inserção na Tabela Correcao
INSERT INTO Correcao (id_correcao, descricao_correcao, resolvido, imagem_anexo, id_aula, id_usuario)
VALUES
...
INSERT INTO Melhoria (id_correcao)
VALUES
    ('correcao_001');

-- Inserção na Tabela ErroVideo
INSERT INTO ErroVideo (id_correcao, time_stamp)
VALUES
    ('correcao_002', 120);

-- Inserção na Tabela ErroConteudo
INSERT INTO ErroConteudo (id_correcao)
VALUES
    ('correcao_003');

-- Inserção na Tabela ErroInterface
INSERT INTO ErroInterface (id_correcao)
VALUES
    ('correcao_004');
