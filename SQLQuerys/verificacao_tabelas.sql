...
DELETE FROM Estudante WHERE id_usuario = 'user1'; -- Falha esperada (há assinaturas dependentes deste estudante)

-- 9. Verificação de integridade ao tentar deletar um Administrador com cursos associados
DELETE FROM Administrador WHERE id_usuario = 'admin1'; -- Falha esperada (há cursos associados a este administrador)
